...
##### estimate genotype posterior probabilities
## I had to break these up to run separately (split list of contigs using 'split -l 5000 regions_2_5kb' and then 'cat' the geno.gz files before running ngsDist
